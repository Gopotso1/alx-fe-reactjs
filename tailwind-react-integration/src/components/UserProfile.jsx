    ...
    <div className="max-w-xs sm:max-w-sm md:max-w-sm lg:max-w-lg mx-auto sm:p-4 md:p-8 lg:p-12 hover:shadow-xl transition-shadow duration-300 ease-in-out">
      <div className="flex flex-col items-center">
        ...
        <img 
          ...
          alt="User Profile" 
          className="sm:w-24 sm:h-24 w-32 h-32 md:w-36 md:h-36 rounded-full border-4 border-gray-300 hover:scale-110 transition-transform duration-300 ease-in-out"
        />
